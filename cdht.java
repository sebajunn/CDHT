...
public class cdht {
        ...
        public void run() {        
            ...
            do {
                try {
                    ...
                    if ("FILE".equals(parsedSentence[0])) {
                    ...
                    } else if ("LIST".equals(parsedSentence[0])) {
                    ...
                    } else if ("QUIT".equals(parsedSentence[0])) {
                    ...
                    } else if ("REQUEST".equals(parsedSentence[0])) {
    ...
    static class PingTask extends TimerTask {
        ...
        public void run() {
            ...
            try {                
                ...
                if (firstLostPings >= MAX_LOST_PINGS || secondLostPings >= MAX_LOST_PINGS) {
                    ...
                    } else // If firstPeer has not yet updated successors then
        ...
        String input;
            ...
            } else if (input.length() == 12 && "request".equalsIgnoreCase(input.substring(0,7))) {
