...
udp_receiver = dsp.UDPReceiver('RemoteIPAddress','127.0.0.1',...
                               'LocalIPPort',IP_port,...
                               'MaximumMessageLength',MaxSegLength ,...
...
while (1)
   ...
   % end
    ...
    j_1 = [1,0,-Dt*velocity*sin(Xe(3)),0];
    j_2 = [0,1,Dt*velocity*cos(Xe(3)),0];
    j_3 = [0,0,1, -1*Dt];
    j_4 = [0,0,0,1];    
    J = [j_1 ;j_2 ;j_3; j_4] ;
   ...
   % J = [j_1 ;j_2 ;j_3; j_4] ;
    ...
    if (trace_flag == 0)
        ...
        set(handles.bias_kalman,'ydata', Xe_History(4,1:length(times)));
    end
    drawnow;
end
